...
void syscall_get_curpath(char *path);
void syscall_set_curpath(char *path);
void syscall_set_var(char *key, char *value, int r, int x);
void syscall_get_var(char *key, char *res);
void syscall_unset_var(char *key);
void syscall_print_var(void);
u_int syscall_get_parent();
